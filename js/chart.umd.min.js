!(function (t, e) {
  ...
  class Es extends e {
    ...
    update(t, e, i) {
      var { beginAtZero: s, grace: a, ticks: n } = this.options,
        ...
        t =
          ...
          o < this.ticks.length);
      this._convertTicksToLabels(t ? As(this.ticks, o) : this.ticks),
        this.configure(),
        ...
        : ((e = (t = this._getLabelSizes()).widest.width),
          ...
          (a.offset ? this.maxWidth / o : s / (o - 1)) < e + 6 &&
            ...
            (c =
              ...
              Ts(a.grid) -
              n.padding -
              Ls(a.title, this.chart.options.font)),
            (d = Math.sqrt(e * e + i * i)),
            (u = ht(
              Math.min(
    ...
    fit() {
      const t = { width: 0, height: 0 },
        ...
        o = this.isHorizontal();
      if (n) {
        const n = Ls(s, e.options.font);
        if (
          (o
            ? ((t.width = this.maxWidth), (t.height = Ts(a) + n))
            : ((t.height = this.maxHeight), (t.width = Ts(a) + n)),
    ...
    _getLabelSizes() {
      ...
      if (!e) {
        ...
        let t = this.ticks;
        i < t.length && (t = As(t, i)),
          (this._labelSizes = e = this._computeLabelSizes(t, t.length));
      }
      return e;
    }
    _computeLabelSizes(t, e) {
      ...
      for (o = 0; o < e; ++o) {
        if (
          ((h = t[o].label),
          (c = this._resolveTickFontOptions(o)),
          (i.font = d = c.string),
          (u = s[d] = s[d] || { data: {}, gc: [] }),
          (g = c.lineHeight),
          (f = p = 0),
          ...
          if (O(h))
            for (r = 0, l = h.length; r < l; ++r)
              P((m = h[r])) ||
                O(m) ||
                ((f = Te(i, u.data, u.gc, f, m)), (p += g));
        } else (f = Te(i, u.data, u.gc, f, h)), (p = g);
        a.push(f), n.push(p), (b = Math.max(f, b)), (x = Math.max(p, x));
      }
      (_ = s),
        (v = e),
        w(_, (t) => {
  ...
  var x = new (class {
    constructor() {
      (this.controllers = new Rs(Ds, "datasets", !0)),
        (this.elements = new Rs(e, "elements")),
        (this.plugins = new Rs(Object, "plugins")),
        (this.scales = new Rs(Es, "scales")),
    ...
    if (
      (t =
        ...
        ("top" === (i = e.position) || "bottom" === i
          ...
          ? "y"
          : void 0) ||
        (1 < t.length && Fs(t[0].toLowerCase(), e)))
    )
      return t;
    throw new Error(
  ...
  function Hs(t, e) {
    let i = Ns.get(t);
    return i || ((i = e()), Ns.set(t, i), Ws.add(i)), i;
  }
  const js = (t, e, i) => {
    e = m(e, i);
    void 0 !== e && t.add(e);
  ...
  class Ys {
    constructor(t) {
      (this._config = (((t = (t = t) || {}).data = Bs(t.data)), Vs(t), t)),
    ...
    getOptionScopes(e, t, i) {
      ...
      const r = new Set(),
        l =
          (t.forEach((t) => {
            e && (r.add(e), t.forEach((t) => js(r, e, t))),
              t.forEach((t) => js(r, s, t)),
              t.forEach((t) => js(r, ge[a] || {}, t)),
              t.forEach((t) => js(r, R, t)),
              t.forEach((t) => js(r, fe, t));
          }),
          Array.from(r));
      return (
    ...
    resolveNamedOptions(t, e, i, s = [""]) {
      const a = { $shared: !0 },
        { resolver: n, subPrefixes: o } = $s(this._resolverCache, t, s);
      let r = n;
      !(function (t, e) {
    ...
    createResolver(t, e, i = [""], s) {
      t = $s(this._resolverCache, t, i).resolver;
  ...
  const Us = (i) =>
    ...
    Xs = ["top", "bottom", "left", "right", "chartArea"];
  function qs(t, e) {
    return "top" === t || "bottom" === t || (-1 === Xs.indexOf(t) && "x" === e);
  }
  function Ks(i, s) {
    return function (t, e) {
  ...
  class i {
    ...
    constructor(t, e) {
      ...
      (this.id = F()),
        ...
        (Qs[this.id] = this),
        t && n
          ? (l.listen(this, "complete", Gs),
            l.listen(this, "progress", Zs),
            this._initialize(),
    ...
    buildOrUpdateControllers() {
      ...
      for (
        ...
        if (
          ...
          (t.type = n),
          (t.indexAxis = a.indexAxis || zs(n, this.options)),
          (t.order = a.order || 0),
          (t.index = s),
          (t.label = "" + a.label),
  ...
  function ea() {
    w(i.instances, (t) => t._plugins.invalidate());
  }
  function ia() {
    throw new Error(
  ...
  var da = Object.freeze({
        ...
        for (let t = i; t < i + s; t++) {
          const i = this.getParsed(t),
            ...
            x = {
              ...
              base: s.base,
              enableBorderRadius:
                !b || oa(i._custom) || o === b._top || o === b._bottom,
              x: h ? s.head : m.center,
              y: h ? m.center : s.head,
    ...
    PieController: class extends ha {
      static id = "pie";
      static defaults = {
        cutout: 0,
        rotation: 0,
  ...
  const _a = "function" == typeof Path2D;
  class ya extends e {
    static id = "line";
    static defaults = {
      borderCapStyle: "butt",
  ...
  var Ca = Object.freeze({
    ...
    PointElement: class extends e {
      ...
      inXRange(t, e) {
        return Ma(this, t, "x", e);
      }
      inYRange(t, e) {
        return Ma(this, t, "y", e);
      }
      getCenterPoint(t) {
        var { x: t, y: e } = this.getProps(["x", "y"], t);
        return { x: t, y: e };
      ...
      draw(t) {
        const {
          ...
          { inner: a, outer: n } =
            ...
            (d = yi(d)),
            (p = {
              t: ka(h.top, d.top, 0, p),
              r: ka(h.right, d.right, 0, c),
              b: ka(h.bottom, d.bottom, 0, p),
              l: ka(h.left, d.left, 0, c),
            }),
            (h = g / 2),
            (d = f / 2),
            ...
            (d = c.borderSkipped),
            (r = {
              topLeft: ka(!(c = r || A(m)) || d.top || d.left, l.topLeft, 0, h),
              topRight: ka(!c || d.top || d.right, l.topRight, 0, h),
              bottomLeft: ka(!c || d.bottom || d.left, l.bottomLeft, 0, h),
              bottomRight: ka(!c || d.bottom || d.right, l.bottomRight, 0, h),
            }),
            {
      ...
      const s = (function (t, e) {
        ...
        for (
          ...
          (d && y !== n
            ? (i.push({ value: n }),
              y < n && S++,
              st(Math.round((y + S * k) * _) / _, n, Aa(n, v, t)) && S++)
            : y < n && S++);
          S < w;
          ++S
        )
        ...
        return (
          b && d && M !== o
            ? i.length && st(i[i.length - 1].value, o, Aa(o, v, t))
  ...
  const Ea = (t) => Math.floor(r(t)),
    Ra = (t, e) => Math.pow(10, Ea(t) + e);
  function Ia(t) {
    return 1 == t / Math.pow(10, Ea(t));
  }
  function za(t, e, i) {
  ...
  class Fa extends Es {
    ...
    parse(t, e) {
      t = Ta.prototype.parse.apply(this, [t, e]);
    ...
    determineDataLimits() {
      ...
      (this.min = p(t) ? Math.max(0, t) : null),
        ...
        this._zero &&
          ...
          !p(this._userMin) &&
          (this.min =
            t === Ra(this.min, 0) ? Ra(this.min, -1) : Ra(this.min, 0)),
        this.handleTickRangeOptions();
    }
    handleTickRangeOptions() {
      ...
      var t = (t) => (s = e ? s : t),
        n = (t) => (a = i ? a : t);
      s === a && (s <= 0 ? (t(1), n(10)) : (t(Ra(s, -1)), n(Ra(a, 1)))),
        s <= 0 && t(Ra(a, -1)),
        a <= 0 && n(Ra(s, 1)),
        (this.min = s),
        (this.max = a);
    ...
    buildTicks() {
      const t = this.options,
        e = (function (t, { min: e, max: i }) {
          ...
          for (; u < i; )
            s.push({ value: u, major: Ia(u), significand: d }),
              10 <= d ? (d = d < 15 ? 15 : 20) : d++,
              20 <= d && (n++, (d = 2), (o = 0 <= n ? 1 : o)),
              (u = Math.round((l + c + d * Math.pow(10, n)) * o) / o);
          return (
            (e = g(t.max, u)),
            s.push({ value: e, major: Ia(e), significand: d }),
            s
          );
  ...
  function Na(e) {
    ...
    for (let t = 0; t < o; t++) {
        ...
        c = Math.round(ht(u));
      {
        ...
        var f = i;
        var p = u;
        var m = Ba(c, h.x, d.w, 0, 180);
        var b = Ba(c, h.y, d.h, 90, 270);
  ...
  class Ha extends Ta {
    ...
    setDimensions() {
      var t = (this._padding = I(Va(this.options) / 2)),
    ...
    generateTickLabels(t) {
      Ta.prototype.generateTickLabels.call(this, t),
  ...
  class Ka extends Es {
    ...
    init(t, e = {}) {
      const i = t.time || (t.time = {}),
        s = (this._adapter = new sa._date(t.adapters.date));
      s.init(e),
    ...
    buildTicks() {
      ...
      return (
        (this._unit =
          e.unit ||
          (i.autoSkip
            ? Ua(e.minUnit, this.min, this.max, this._getLabelCapacity(a))
            : (function (e, i, s, a, n) {
                for (let t = h.length - 1; t >= h.indexOf(s); t--) {
                  const s = h[t];
                  if (ja[s].common && e._adapter.diff(n, a, s) >= i - 1)
                    return s;
                }
          ...
          i.major.enabled && "year" !== this._unit
            ? (function (i) {
                for (let t = h.indexOf(i) + 1, e = h.length; t < e; ++t)
                  if (ja[h[t]].common) return h[t];
              })(this._unit)
            : void 0),
        this.initOffsets(s),
        t.reverse && n.reverse(),
        qa(this, n, this._majorUnit)
      );
    }
    afterAutoSkip() {
    ...
    _generate() {
      const t = this._adapter,
        ...
        s = this.options,
        a = s.time,
        n = a.unit || Ua(a.minUnit, e, i, this._getLabelCapacity(e)),
      ...
      for (c = u, d = 0; c < i; c = +t.add(c, o, n), d++) Xa(h, c, g);
      return (
        (c !== i && "ticks" !== s.bounds && 1 !== d) || Xa(h, c, g),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
    ...
    _getLabelCapacity(t) {
      var e = this.options.time,
        ...
        i = this._tickFormatFunction(t, 0, qa(this, [t], this._majorUnit), e),
    ...
    getLabelTimestamps() {
      ...
      for (e = 0, i = s.length; e < i; ++e) t.push($a(this, s[e]));
  ...
  var Za = Object.freeze({
    __proto__: null,
    CategoryScale: class extends Es {
      static id = "category";
    ...
    TimeScale: Ka,
    TimeSeriesScale: class extends Ka {
      static id = "timeseries";
      static defaults = Ka.defaults;
      constructor(t) {
        super(t),
          (this._table = []),
          (this._minPos = void 0),
      ...
      initOffsets() {
        ...
        (this._minPos = Ga(e, this.min)),
          (this._tableRange = Ga(e, this.max) - this._minPos),
          super.initOffsets(t);
      }
      buildLookupTable(t) {
      ...
      getValueForPixel(t) {
        var e = this._offsets,
          t = this.getDecimalForPixel(t) / e.factor - e.end;
        return Ga(this._table, t * this._tableRange + this._minPos, !0);
      }
    },
  });
  const Ja = [
    ...
    Qa = Ja.map((t) => t.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
  function tn(t) {
    return Ja[t % Ja.length];
  }
  function en(t) {
    ...
    return (t, e) => {
      ...
      e instanceof ha
        ? (o =
            ((s = t),
            (a = o),
            (s.backgroundColor = s.data.map(() => tn(a++))),
            a))
        : e instanceof ca
        ? (o =
            ((s = t),
            (i = o),
            (s.backgroundColor = s.data.map(() => en(i++))),
            i))
        : e &&
          (o =
            ((e = t),
  ...
  function un(e, t) {
    ...
    return (i = O(e)
      ...
      ? new ya({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
      : null;
  }
  function gn(t) {
    return t && !1 !== t.fill;
  ...
  function mn(t) {
    ...
    if ("stack" === a) {
      ...
      u.push(un({ x: null, y: o.bottom }, l));
      for (let t = 0; t < c.length; t++) {
        const o = c[t];
        for (let t = o.start; t <= o.end; t++) fn(h, d[t], u);
      }
      return new ya({ points: h, options: {} });
    }
    if ("shape" === a) return !0;
    s = (function (t) {
    ...
    return s instanceof pn ? s : un(s, n);
  }
  function bn(t, e, i) {
    var s,
      a = mn(e),
    ...
    a &&
      ...
      "x" === e &&
        i !== r &&
        (xn(s, l, n.top),
        vn(s, { line: a, target: l, color: r, scale: o, property: e }),
        s.restore(),
        s.save(),
        xn(s, l, n.bottom)),
      vn(s, { line: a, target: l, color: i, scale: o, property: e }),
      s.restore(),
      Be(t));
  }
  function xn(t, e, i) {
    ...
    const { line: s, target: a, property: n, color: o, scale: r } = i,
      l = (function (t, e, i) {
        ...
        for (const t of s) {
          var { start: r, end: l } = t,
            l = cn(r, l, a),
            h = hn(i, a[r], a[l], t.loop);
          if (e.segments) {
            var c = Li(e, h);
            for (const e of c) {
              const s = hn(i, n[e.start], n[e.end], e.loop),
                d = Ti(t, a, s);
              for (const t of d)
                o.push({
                  source: t,
                  target: e,
                  start: { [i]: dn(h, s, "start", Math.max) },
                  end: { [i]: dn(h, s, "end", Math.min) },
                });
            }
    ...
    beforeDatasetsDraw(e, t, i) {
      if ("beforeDatasetsDraw" === i.drawTime) {
        ...
        for (let t = s.length - 1; 0 <= t; --t) {
          const i = s[t].$filler;
          gn(i) && bn(e.ctx, i, e.chartArea);
        }
      }
    },
    beforeDatasetDraw(t, e, i) {
      e = e.meta.$filler;
      gn(e) && "beforeDatasetDraw" === i.drawTime && bn(t.ctx, e, t.chartArea);
    },
  ...
  class wn extends e {
    ...
    fit() {
      ...
      if (i.display) {
        var a = i.labels,
          ...
          { boxWidth: a, itemHeight: l } = Mn(a, o);
        let t, e;
        (s.font = n.string),
          this.isHorizontal()
          ...
          var i,
            ...
            { itemWidth: t, itemHeight: o } = {
              ...
              itemHeight: (function (t) {
                let e = n;
                return (e = "string" != typeof a.text ? kn(a, t) : e);
              })(i.lineHeight),
            };
          0 < e &&
            b + o + 2 * d > f &&
    ...
    _draw() {
      ...
      this.drawTitle(),
        ...
        (u.lineWidth = 0.5),
        (u.font = b.string);
      const { boxWidth: M, boxHeight: w, itemHeight: k } = Mn(f, v),
        S = this.isHorizontal(),
  ...
  var Sn = {
    ...
    _element: wn,
    start(t, e, i) {
      var s = (t.legend = new wn({ ctx: t.ctx, options: i, chart: t }));
  ...
  var Dn = {
    ...
    start(t, e, i) {
      ...
      (t = t),
        (i = i),
        (s = new Pn({ ctx: t.ctx, options: i, chart: t })),
        a.configure(t, s, i),
        a.addBox(t, s),
        (t.titleBlock = s);
    },
  ...
  var On = {
    id: "subtitle",
    start(t, e, i) {
      var s = new Pn({ ctx: t.ctx, options: i, chart: t });
      a.configure(t, s, i), a.addBox(t, s), Cn.set(t, s);
    },
    stop(t) {
      a.removeBox(t, Cn.get(t)), Cn.delete(t);
    },
    beforeUpdate(t, e, i) {
      const s = Cn.get(t);
      a.configure(t, s, i), (s.options = i);
  ...
  function Ln(t, e) {
    ...
    return (
      ...
      w(s, (t) => {
        w(t.before, v), w(t.lines, v), w(t.after, v);
      }),
      (x = 0),
      (i.font = c.string),
      w(t.footer, v),
  ...
  function k(t, e, i, s) {
    t = t[e].call(i, s);
    return void 0 === t ? Vn[e].call(i, s) : t;
  }
  class Bn extends e {
    ...
    getTitle(t, e) {
      var e = e["callbacks"],
        i = k(e, "beforeTitle", this, t),
        s = k(e, "title", this, t),
        e = k(e, "afterTitle", this, t),
        t = M([], Tn(i));
      return (t = M(t, Tn(s))), M(t, Tn(e));
    }
    getBeforeBody(t, e) {
      return zn(k(e.callbacks, "beforeBody", this, t));
    }
    getBody(t, e) {
      const s = e["callbacks"],
        a = [];
      return (
        w(t, (t) => {
          var e = { before: [], lines: [], after: [] },
            i = Fn(s, t);
          M(e.before, Tn(k(i, "beforeLabel", this, t))),
            M(e.lines, k(i, "label", this, t)),
            M(e.after, Tn(k(i, "afterLabel", this, t))),
            a.push(e);
        }),
        a
      );
    ...
    getAfterBody(t, e) {
      return zn(k(e.callbacks, "afterBody", this, t));
    }
    getFooter(t, e) {
      var e = e["callbacks"],
        i = k(e, "beforeFooter", this, t),
        s = k(e, "footer", this, t),
        e = k(e, "afterFooter", this, t),
        t = M([], Tn(i));
      return (t = M(t, Tn(s))), M(t, Tn(e));
    }
    _createItems(s) {
      ...
      return (
        ...
        w((l = s.itemSort ? l.sort((t, e) => s.itemSort(t, e, a)) : l), (t) => {
          var e = Fn(s.callbacks, t);
          i.push(k(e, "labelColor", this, t)),
            n.push(k(e, "labelPointStyle", this, t)),
            o.push(k(e, "labelTextColor", this, t));
        }),
        (this.labelColors = i),
      ...
      if (s.length) {
        const t = An[i.position].call(this, s, this._eventPosition),
          e =
            ...
            (this._size = Ln(this, i))),
          o = Object.assign({}, t, e),
          r = En(this.chart, i, o),
          l = Rn(i, o, r, this.chart);
    ...
    drawBody(e, i, t) {
      ...
      (u = 0), (d = c.lineHeight), w(this.afterBody, g), (e.y -= a);
    }
    drawFooter(t, e, i) {
      var s = this.footer,
        a = s.length;
  ...
  var Nn = {
    ...
    positioners: An,
    afterInit(t, e, i) {
      i && (t.tooltip = new Bn({ chart: t, options: i }));
    },
    beforeUpdate(t, e, i) {
